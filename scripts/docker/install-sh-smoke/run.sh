...
SMOKE_MODE="${QVERISBOT_INSTALL_SMOKE_MODE:-${OPENCLAW_INSTALL_SMOKE_MODE:-install}}"
SMOKE_PREVIOUS_VERSION="${QVERISBOT_INSTALL_SMOKE_PREVIOUS:-${OPENCLAW_INSTALL_SMOKE_PREVIOUS:-}}"
SKIP_PREVIOUS="${QVERISBOT_INSTALL_SMOKE_SKIP_PREVIOUS:-${OPENCLAW_INSTALL_SMOKE_SKIP_PREVIOUS:-0}}"
...
FRESH_VERSION="${QVERISBOT_INSTALL_FRESH_VERSION:-${OPENCLAW_INSTALL_FRESH_VERSION:-}}"
FRESH_TAG_URL="${QVERISBOT_INSTALL_FRESH_TAG_URL:-${OPENCLAW_INSTALL_FRESH_TAG_URL:-}}"
UPDATE_BASELINE_VERSION="${QVERISBOT_INSTALL_UPDATE_BASELINE:-${OPENCLAW_INSTALL_UPDATE_BASELINE:-2026.4.10}}"
UPDATE_BASELINE_TAG_URL="${QVERISBOT_INSTALL_UPDATE_BASELINE_TAG_URL:-${OPENCLAW_INSTALL_UPDATE_BASELINE_TAG_URL:-}}"
UPDATE_EXPECT_VERSION="${QVERISBOT_INSTALL_UPDATE_EXPECT_VERSION:-${OPENCLAW_INSTALL_UPDATE_EXPECT_VERSION:-}}"
UPDATE_TAG_URL="${QVERISBOT_INSTALL_UPDATE_TAG_URL:-${OPENCLAW_INSTALL_UPDATE_TAG_URL:-}}"
...
NODE
  ...
  echo "==> Verify installed version"
  local latest_out_path="${QVERISBOT_INSTALL_LATEST_OUT:-${OPENCLAW_INSTALL_LATEST_OUT:-}}"
