...
import { createRuntimeX } from "./runtime-x.js";
...
export function createRuntimeChannel(): PluginRuntime["channel"] {
  const channelRuntime = {
    ...
    "discord" | "slack" | "matrix" | "signal" | "line" | "x"
  > &
    Partial<
      Pick<PluginRuntime["channel"], "discord" | "slack" | "matrix" | "signal" | "line" | "x">
    >;
  ...
  defineCachedValue(channelRuntime, "x", createRuntimeX);
