...
import { loadIpAddrModule } from "./ipaddr-runtime.js";

const ipaddr = loadIpAddrModule();

export type ParsedIpAddress = IpAddrModule.IPv4 | IpAddrModule.IPv6;
type Ipv4Range = ReturnType<IpAddrModule.IPv4["range"]>;
type Ipv6Range = ReturnType<IpAddrModule.IPv6["range"]>;
...
const RFC2544_BENCHMARK_PREFIX: [IpAddrModule.IPv4, number] = [ipaddr.IPv4.parse("198.18.0.0"), 15];
...
function parseIpv6WithEmbeddedIpv4(raw: string): IpAddrModule.IPv6 | undefined {
...
export function isIpv4Address(address: ParsedIpAddress): address is IpAddrModule.IPv4 {
  return address.kind() === "ipv4";
}

export function isIpv6Address(address: ParsedIpAddress): address is IpAddrModule.IPv6 {
...
export function isBlockedSpecialUseIpv6Address(address: IpAddrModule.IPv6): boolean {
...
function decodeIpv4FromHextets(high: number, low: number): IpAddrModule.IPv4 {
...
export function extractEmbeddedIpv4FromIpv6(
  address: IpAddrModule.IPv6,
): IpAddrModule.IPv4 | undefined {
  if (address.isIPv4MappedAddress()) {
    return address.toIPv4Address();
  }
